...
const Preview = () => {
  ...
  return (
    <div
      className="flex w-[calc(100%+80px)] -mx-[40px] h-full min-h-[420px] md:min-h-[600px] justify-center items-center bg-transparent overflow-hidden"
      ref={scope}
    >
      <motion.div
      ...
      >
        <p
          className="text-5xl md:text-7xl z-50 text-white font-calendas italic"
          style={{ marginTop: "-5px" }}
        >
