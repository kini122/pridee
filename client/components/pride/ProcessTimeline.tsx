...
const STEPS = [
  {
    ...
    desc: "Every extraordinary event begins with listening. We immerse ourselves in your goals, brand, and audience to craft a tailored strategy.",
    points: [
  ...
  },
  {
    ...
    desc: "Our creative team transforms your vision into a compelling event concept with mood boards, themes, and innovative ideas.",
    points: [
  ...
  },
  {
    ...
    desc: "Meticulous planning ensures flawless execution. We coordinate every element from logistics to guest experience.",
    points: [
  ...
  },
  {
    ...
    desc: "Our production team handles all technical aspects, ensuring seamless integration of AV, staging, lighting, and décor.",
    points: [
  ...
  },
  {
    ...
    desc: "On event day, our team orchestrates every moment, managing logistics and ensuring your guests have an unforgettable experience.",
    points: [
  ...
  },
  {
    ...
    desc: "We provide comprehensive post-event analysis, gathering insights and feedback to measure impact and inform future events.",
    points: [
  ...
  return (
    <section id="process" className="relative py-[80px] px-[40px] min-h-[400vh] snap-start">
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <video className="absolute inset-0 w-full h-full object-cover" src="/videos/process.mp4" preload="auto" decoding="async" autoPlay muted loop playsInline poster="/placeholder.svg" style={{ filter: 'contrast(1.05) saturate(1.05)', imageRendering: 'auto' }} />
